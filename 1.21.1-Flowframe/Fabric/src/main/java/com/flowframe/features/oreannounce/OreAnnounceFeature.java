                ...
                for (String line : filtered) {
                    ...
                    if (minedIdx > 0 && atPos > minedIdx) {
                        ...
                        if (xyz.length == 3) {
                            ...
                            final Text finalText = text.copy().styled(style -> style
                                    .withClickEvent(
